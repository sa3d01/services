...
@section('title', 'مزودى الخدمات المعلقيين')
@section('styles')
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="button-list">
                                            ...
                                            <form class="reject" data-href="{{ route('admin.provider.reject',[$row->id]) }}" data-id="{{$row->id}}">
                                                @csrf
                                                <button class="btn btn-danger waves-effect waves-light"> <i class="fa fa-archive mr-1"></i> <span>رفض</span> </button>
                                            </form>
                                            <form class="accept" data-id="{{$row->id}}" data-href="{{ route('admin.provider.accept',[$row->id]) }}">
                                                @csrf
