...
{{--                                <input type="text" name="marketer_id" required class="form-control" id="marketer_id">--}}
{{--                            </div>--}}
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" value="1" min="1" max="100" name="discount_percent" required class="form-control" id="discount_percent">
                            </div>
                            <div class="form-group">
                                <label for="count_of_uses">عدد مرات الاستخدام المتاحه*</label>
                                <input type="number" min="1" value="1" name="count_of_uses" required class="form-control" id="count_of_uses">
                            </div>
                            <div class="form-group">
