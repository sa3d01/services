            ...
            <div class="col-md-6 mx-auto my-3">
                ...
                <form action="">
                    <div class="form-group wow fadeInDown">
                        <input type="password" class="form-control" placeholder="كلمة المرور الحالية" id="oldPass">
                        <i class="fas fa-eye togglePass yellow " toggle="#oldPass"></i>
                    </div>
                    <div class="form-group wow fadeInDown">
                        <input type="password" class="form-control" placeholder="كلمة المرور الجديدة" id="newpass">
                        <i class="fas fa-eye togglePass yellow " toggle="#newpass"></i>
                    </div>

                    <a href="../user-editprofile.blade.php" class="btn btn-blue mt-4 w-100 wow fadeInUp">
                        حفظ
                    </a>
                </form>
            </div>
